...
pitches <- read.csv("pitches.csv", nrows = 1000) # added 'nrows' argument to only read in 1000 rows for speed
str(pitches)  
...
# ----------------------------------------------------------------------------------------------------
# bootstrap to extract beta for the 100 sample 
...
my_timer$stop("lasso   whole data")
...
my_timer$stop("ridge   whole data")
...
beta.rf.bs  =     as.vector(rf.fit$beta)
my_timer$stop("random forest   whole data")
...
# --------------------------------------------------------------------------------------------------------------------
# getting beta and err for graph
